...
- External validation set: CMC Vellore, India (n=102) - Private dataset, available on reasonable request but available as PNG format under `data/pre-processed/anonymized_cmc_png`
